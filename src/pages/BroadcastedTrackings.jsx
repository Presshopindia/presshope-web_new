          ...
          <Col>
            <div className="bTask_list_card">
              ...
              <div className="taskcard_body ps-0 pe-1 pb-0">
                ...
                <div className="mapInput mapView position-relative mt-3">
                  <GoogleMap
                          ...
                          {taskDetails?.content &&
                            taskDetails?.content.map((curr) => {
                              ...
                              if (curr?.media_type === "video")
                                return (
                                  <img
                                    src={`${process.env.REACT_APP_UPLOADED_CONTENT}${curr?.thumbnail}`}
                                  />
                                );
                            })}
                        </div> */}
