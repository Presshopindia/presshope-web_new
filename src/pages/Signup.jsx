...
const Signup = () => {
  ...
  const {adminPreRegistrationEmail,setAdminPreRegistrationEmail } = useDarkMode();
  ...
  const NextPage = async (e) => {
    ...
    if (officeNames.length === 0) {
      ...
      const userEmailId = localStorage.getItem("UserEmailId");
       console.log("adminPreRegistrationEmail ----->  ------->",adminPreRegistrationEmail);
  ...
  const AddOffice = async (e) => {
    ...
    try {
      ...
      console.log("adminPreRegistrationEmail office details ---->   ----->",adminPreRegistrationEmail);
      const step2Data = {
        email: userEmailId ?? adminPreRegistrationEmail,
        step2: {
          company_details: AdminDetails?.company_details,
  ...
  useEffect(() => {
    const handleBeforeUnload = (event) => {
      if (isWindowShowMessage) {
        const message = "You have unsaved changes. If you leave, you will lose your data.";
                                    ...
                                    <input
                                      ...
                                      onChange={(e) => {
                                        if (e.target.value.length <= 10) {
                                          ...
                                          handleValidation(index, e.target.value);
                                        }
                                      }}
                                      maxLength={10}
                                      value={el.phone || ""}
                              ...
                              <Col md={6} className="admn_numb_wrap">
                                <div className="number_inp_wrap w-100">
                                  ...
                                  <PhoneInput
                                    ...
                                    // readOnly
                                  />
                                  {AdminDetails.administrator_details.phone.length<10?(<span
                                      style={{ color: "red" }}
                                      className="eml_txt_dngr"
                                    >
