...
//   const [sortFilterPurchasedContent, setSortFilterPurchasedContent] = useState(initStateOfSortFilterPurchasedContent);
...
//     try {
//       setLoading(true);
//       const resp = await Get(`mediaHouse/getuploadedContentbyHoppers?limit=20&${sortFilterPurchasedContent?.sortField}=${sortFilterPurchasedContent?.sortValue}&favContent=${sortFilterPurchasedContent?.favContent}&category=${sortFilterPurchasedContent?.category}`);
//       if (resp) {
...
//                                 ) : null;
//                               })}
//                           <span onClick={() => navigate("/dashboard-tables/broadcasted_task")}>
//                             <BsArrowRight />
//                           </span>
//                         </div>
//                       </CardActions>
...
//                       <CardActions className="dash-c-foot">
//                         <div className="card-imgs-wrap">
//                           {stats?.sourced_content_from_tasks?.task?.slice(0, 3).map((curr, index) => {
//                             return (
//                               <div key={index}>
//                                 {curr?.type === "image" ? (
//                                   <img
...
//                       <CardActions className="dash-c-foot">
//                         <div className="card-imgs-wrap">
//                           {stats?.today_fund_invested?.task?.slice(0, 3).map((curr, index) => {
//                             return (
//                               <div key={index}>
//                                 {curr?.type === "image" ? (
//                                   <img
...
//                             className="card-head-txt mb-2"
//                           >
//                             £{formatAmountInMillion(stats?.total_fund_invested?.count)}
//                           </Typography>
//                         </div>
//                         <Typography
//                           sx={{ fontSize: 14 }}
...
//                       <CardActions className="dash-c-foot">
//                         <div className="card-imgs-wrap">
//                           {stats?.total_fund_invested?.data?.slice(0, 3).map((curr, index) => {
//                             return (
//                               <div key={index}>
//                                 {curr?.type === "image" ? (
//                                   <img
...
const BroadcastedTask = () => {
  ...
  // const AllTaskDetailsContents = async (id) => {
  ...
  const TaskDetails = async (id) => {
    ...
    try {
      ...
      console.log("errrrortrtnmvnbnmvcbv---->", error);
      setLoading(false);
    }
  };
  ...
  // const handleBasket = (index, y, z) => {
  //   const data=taskDetails[index]
  //     data.basket_status=true;
  //     setTaskDetails(old=>[...old,data])
  //   console.log("yyyyyy------>", z);
  // };
