              ...
              return (
                <div className="chatting_itm d-flex align-items-start" key={curr?._id}>
                  ...
                  <div className="postedcmnt_info">
                    ...
                    <div
                      onClick={() => {
                        setPreviewImage(curr);
                        handleShowImage();
                      }}
                      className="exp clickable"
                    >
                      {curr?.messageType === "image" && (
                        <img src={curr?.message} className="msgContent" style={{ width: "40%", height: "40%" }} />
                      )}
                    </div>
        ...
        <Form onSubmit={handleSendClick}>
          <div className="chatting_type position-relative">
            ...
            <div className="chatIn-options">
              <div className="uplod-mda clickable">
                <MdAdd className="clickable" />
