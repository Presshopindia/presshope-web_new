...
const RelatedMoreContentSort = ({ closeRelatedMoreContentSort, RelatedMoreContentSortValues }) => {

  const handleClose = (values) => {
    closeRelatedMoreContentSort(values)
  }
  return (
    <>
      <div className="filter_wrap">
        ...
        <div className="sort_list">
          <div className="sort_item" onClick={(e) => handleSort("activity", "old")}>
            <img src={relevanceic} className="icn" alt="relevance" />
            <p className="sort_txt">Relevance</p>
          </div>
          <div className="sort_item" onClick={(e) => handleSort("activity", "new")}>
            <img src={latestic} className="icn" alt="Latest content" />
            <p className="sort_txt">Latest content</p>
          </div>
          <div className="sort_item" onClick={(e) => handleSort("low_price_content", "low_price_content")}>
            <img
              src={lowestprcdic}
              className="icn"
              alt="Lowest priced content"
            />
            <p className="sort_txt" onClick={() => {

            }}>Lowest priced content</p>
          </div>
          <div className="sort_item" onClick={() => handleSort("high_price_content", "high_price_content")}>
            <img
              src={highestprcdic}
              className="icn"
        ...
        <div className="sort_list">
          ...
          <div className="sort_item">
            <img src={contentic} className="icn" alt="Under offer" />
            <p className="sort_txt">Purchased content</p>
          </div>
          <div className="sort_item">
...
export default RelatedMoreContentSort;
